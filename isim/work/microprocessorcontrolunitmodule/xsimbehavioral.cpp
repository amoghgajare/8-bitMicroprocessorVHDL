...
public:
    ...
    HSimConfigDecl * topModuleInstantiate() {
        ...
        HSim__s6 * topvh = 0;
        extern HSim__s6 * createWork_microprocessorcontrolunitmodule_behavioral(const char*);
        topvh = createWork_microprocessorcontrolunitmodule_behavioral("MicroprocessorControlUnitModule");
